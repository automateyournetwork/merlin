...
$ pyats run job IOS_XE_Cisco_API_merlin_job.py --testbed-file testbed/testbed_cisco_api.yaml
...
def main(runtime):
    ...
    testscript = os.path.join(os.path.dirname(__file__), 'IOS_XE_Cisco_API_merlin.py')
