...
if os.path.exists("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.json"):
    os.remove("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.json")

if os.path.exists("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.yaml"):
    os.remove("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.yaml")

if os.path.exists("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory_DB.json"):
    os.remove("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory_DB.json")       

Nexus9k_Inventory_DB = TinyDB('Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory_DB.json')
...
class Collect_Information(aetest.Testcase):
    ...
    def parse(self, testbed, section, steps):
        ...
        # ---------------------------------------
        with open("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.csv",'w') as csv:
            csv.seek(0, 0)
            ...
            csv.close()  
        with open("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.md",'w') as md:
            md.seek(0, 0)
            md.write("# Inventory")
            md.write("\n")
            ...
            md.write("| -------- | ---- | ---- | ----------- | ------------- | ---------- | ------- | ------------ | ------------------- | --------------------- | ------------------ |")
            md.close()
        with open("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.html",'w') as html:
            html.seek(0, 0)
        ...
        for device in testbed:
            ...
            # ----------------
            table = Nexus9k_Inventory_DB.table(device.alias)
            ...
            with steps.start('Store data',continue_=True) as step:
                ...
                if device.os == "nxos":
                    if self.parsed_show_interface_transceiver is not None:
                        ...
                        with open("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.json", "a") as fid:
                            json.dump(self.parsed_show_interface_transceiver, fid, indent=4, sort_keys=True)
                            fid.write('\n')
                                
                        with open("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.yaml", "a") as yml:
                        ...
                        for filetype in filetype_loop:
                            ...
                            with open("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.%s" % filetype, "a") as fh:
        ...
        with open("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.html", "a") as html:
            html.write("</table></body></html>")
            html.close() 
                            
        if os.path.exists("Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.md"):
            os.system("markmap --no-open Camelot/Cisco/DevNet_Sandbox/Excalibur/Nexus9k_Inventory.md --output Camelot/Cisco/DevNet_Sandbox/Excalibur/Inventory_mind_map.html")
