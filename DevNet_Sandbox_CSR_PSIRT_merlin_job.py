...
$ pyats run job DevNet_Sandbox_CSR_PSIRT_merlin_job.py --testbed-file testbed/testbed_DevNet_CSR1000v_Sandbox.yaml
...
def main(runtime):
    ...
    testscript = os.path.join(os.path.dirname(__file__), 'DevNet_Sandbox_CSR_PSIRT_merlin.py')
